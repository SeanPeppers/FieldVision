...
# --- CHANGE 1: Set HM_METHOD to 'asift' to match your homography files ---
HM_METHOD="asift" # Now explicitly using 'asift' for homography method
...
# This path now correctly points to H_asift.csv
HOMOGRAPHY_MATRICES_FILE="$HOMOGRAPHY_RESULTS_DIR/homography_matrices/H_${HM_METHOD}.csv"

# Output directories for this script's phases - these will now use 'asift' in their names
...
# --- CHANGE 2: Dynamically set the expected group homography prefix based on HM_METHOD ---
GROUP_HM_PREFIX="H_${HM_METHOD}_group_" # This will now be "H_asift_group_"

# Find all H_asift_group_*.csv files generated by split_for_mini.py
# This `find` command now correctly uses the `HM_METHOD` variable to find the group homographies.
...
# --- CHANGE 3: Update the WARNING message to reflect the correct prefix ---
