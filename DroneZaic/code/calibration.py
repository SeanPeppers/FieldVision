...
paths = args.image_path + '/*.tif' # change for other types
...
print("DEBUG: Path being globbed: {}".format(paths))
print("DEBUG: Number of images found by glob.glob: {}".format(len(images)))
if images:
    print("DEBUG: First image in list: {}".format(images[0]))
